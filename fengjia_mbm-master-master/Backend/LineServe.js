...
app.use(cors({
    origin: ['http://localhost:5173', 'https://sandbox-web-pay.line.me','http://localhost'],
    methods: ['GET', 'POST'],
...
app.post('/create-payment', async (req, res) => {
        ...
        const requestBody = {
            ...
            redirectUrls: {
                confirmUrl: ['http://localhost:5173/confirm', 'http://localhost'],
                cancelUrl: ['http://localhost:5173/cancel', 'http://localhost'],
            }
        };
